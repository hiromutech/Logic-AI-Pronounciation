...
<center>
    ...
    <div class="pass1">
        ...
        <img src="../assets/images/eyeclose.png" id="eyeicon1">
    </div>
    ...
    <script>
        ...
        eyeicon1.onclick = function(){
            if (password1.type =="password"){
                password1.type = "text";
                eyeicon1.src = filePath + "eyeopen.jpg";
            }else {
                password1.type = "password";
                eyeicon1.src = filePath + "eyeclose.png";
            }
        }
    </script>
...
<!-- <script>
    ...
    &nbsp;
    <a href="login.php" class="btn_sign">LOG IN</a>
    &nbsp;
